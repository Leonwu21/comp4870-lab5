...
public class UnitTest
{
    ...
    [Fact]
    public void Given0KelvinOutput_459point4Fahrenheit()
    {
        Conversion conversion = new Conversion();
    ...
    [Fact]
    public void Given100KelvinOutput_279point4Fahrenheit()
    {
        Conversion conversion = new Conversion();
    ...
    [Fact]
    public void Given0KelvinOutput_273Celsius()
    {
        Conversion conversion = new Conversion();
        double expected = -237;
    ...
    [Fact]
    public void Given100KelvinOutput_173Celsius()
    {
        Conversion conversion = new Conversion();
        double expected = -173;
    ...
    [Fact]
    public void Given0FahrenheitOutput255point22Kelvin()
    {
        Conversion conversion = new Conversion();
